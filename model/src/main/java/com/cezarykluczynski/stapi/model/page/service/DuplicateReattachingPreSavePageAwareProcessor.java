...
@Service
@Slf4j
public class DuplicateReattachingPreSavePageAwareProcessor extends AbstractPageAttacher implements PreSavePageAwareProcessor {

	private PageRepository pageRepository;

	@Inject
	public DuplicateReattachingPreSavePageAwareProcessor(PageRepository pageRepository) {
	...
	public List<PageAware> process(List<PageAware> pageAwareList) {
		...
		if (!pageList.isEmpty()) {
			log.info("Found {} Page entities to be attached", pageList);
