...
class TitleRepositoryImplTest extends AbstractTitleTest {
	...
	void setup() {
		titleQueryBuilderFactory = Mock()
		titleRepositoryImpl = new TitleRepositoryImpl(titleQueryBuilderFactory)
	...
	void "query is built and performed"() {
		...
		1 * titleQueryBuilderFactory.createQueryBuilder(pageable) >> titleQueryBuilder
