...
class MaterialTest extends AbstractMaterialTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * materialApiMock.v1Get(UID) >> materialFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * materialApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, CHEMICAL_COMPOUND, BIOCHEMICAL_COMPOUND,
