...
class AstronomicalObjectTest extends AbstractAstronomicalObjectTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * astronomicalObjectApiMock.v1GetAstronomicalObject(UID) >> astronomicalObjectFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * astronomicalObjectApiMock.v1SearchAstronomicalObjects(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, ASTRONOMICAL_OBJECT_TYPE,
	...
	void "searches entities (V2)"() {
		...
		then:
		1 * astronomicalObjectApiMock.v2SearchAstronomicalObjects(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME,
