...
class MagazineTest extends AbstractMagazineTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * magazineApiMock.v1RestMagazineGet(UID) >> magazineFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * magazineApiMock.v1RestMagazineSearchPost(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, TITLE, PUBLISHED_YEAR_FROM, PUBLISHED_YEAR_TO,
