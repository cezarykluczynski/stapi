...
class BookSeriesTest extends AbstractBookSeriesTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * bookSeriesApiMock.v1RestBookSeriesGet(UID) >> bookSeriesFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * bookSeriesApiMock.v1RestBookSeriesSearchPost(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, TITLE, PUBLISHED_YEAR_FROM, PUBLISHED_YEAR_TO,
