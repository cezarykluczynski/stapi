...
class WeaponTest extends AbstractWeaponTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * weaponApiMock.v1GetWeapon(UID) >> weaponFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * weaponApiMock.v1SearchWeapons(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, HAND_HELD_WEAPON, LASER_TECHNOLOGY, PLASMA_TECHNOLOGY,
	...
	void "searches entities (V2)"() {
		...
		when:
		WeaponV2BaseResponse weaponV2BaseResponseOutput = weapon.searchV2(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, HAND_HELD_WEAPON,
				LASER_TECHNOLOGY, PLASMA_TECHNOLOGY, PHOTONIC_TECHNOLOGY, PHASER_TECHNOLOGY, DIRECTED_ENERGY_WEAPON, EXPLOSIVE_WEAPON,
				PROJECTILE_WEAPON, FICTIONAL_WEAPON, MIRROR, ALTERNATE_REALITY)
