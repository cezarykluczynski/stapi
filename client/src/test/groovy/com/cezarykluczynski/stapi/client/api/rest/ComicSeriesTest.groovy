...
class ComicSeriesTest extends AbstractComicSeriesTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * comicSeriesApiMock.v1RestComicSeriesGet(UID, null) >> comicSeriesFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * comicSeriesApiMock.v1RestComicSeriesSearchPost(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, null, TITLE, PUBLISHED_YEAR_FROM, PUBLISHED_YEAR_TO,
