...
class EpisodeTest extends AbstractEpisodeTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * episodeApiMock.v1RestEpisodeGet(UID, null) >> episodeFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * episodeApiMock.v1RestEpisodeSearchPost(PAGE_NUMBER, PAGE_SIZE, SORT, null, TITLE, SEASON_NUMBER_FROM, SEASON_NUMBER_TO, EPISODE_NUMBER_FROM,
