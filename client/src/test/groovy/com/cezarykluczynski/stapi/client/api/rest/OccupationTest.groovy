...
class OccupationTest extends AbstractOccupationTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * occupationApiMock.v1GetOccupation(UID) >> occupationFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * occupationApiMock.v1SearchOccupations(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, LEGAL_OCCUPATION, MEDICAL_OCCUPATION,
