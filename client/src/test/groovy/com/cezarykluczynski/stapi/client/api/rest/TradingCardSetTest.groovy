...
class TradingCardSetTest extends AbstractTradingCardSetTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * tradingCardSetApiMock.v1RestTradingCardSetGet(UID, API_KEY) >> tradingCardSetFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * tradingCardSetApiMock.v1RestTradingCardSetSearchPost(PAGE_NUMBER, PAGE_SIZE, SORT, API_KEY, NAME, RELEASE_YEAR_FROM, RELEASE_YEAR_TO,
