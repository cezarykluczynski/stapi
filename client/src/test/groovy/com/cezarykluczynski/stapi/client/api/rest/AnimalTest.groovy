...
class AnimalTest extends AbstractAnimalTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * animalApiMock.v1Get(UID) >> animalFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * animalApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, EARTH_ANIMAL, EARTH_INSECT, AVIAN, CANINE,
