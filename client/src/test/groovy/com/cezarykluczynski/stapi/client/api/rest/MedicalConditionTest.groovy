...
class MedicalConditionTest extends AbstractMedicalConditionTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * medicalConditionApiMock.v1Get(UID) >> medicalConditionFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * medicalConditionApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, PSYCHOLOGICAL_CONDITION) >>
