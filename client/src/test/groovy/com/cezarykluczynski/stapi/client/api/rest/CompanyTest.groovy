...
class CompanyTest extends AbstractCompanyTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * companyApiMock.v1Get(UID) >> companyFullResponse
		0 * _
	...
	void "gets single entity (V2)"() {
		...
		then:
		1 * companyApiMock.v2Get(UID) >> companyV2FullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * companyApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, BROADCASTER, COLLECTIBLE_COMPANY,
	...
	void "searches entities (V2)"() {
		...
		then:
		1 * companyApiMock.v2Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, BROADCASTER, STREAMING_SERVICE,
