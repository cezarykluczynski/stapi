...
class SpacecraftClassTest extends AbstractSpacecraftClassTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * spacecraftClassApiMock.v1GetSpacecraftClass(UID) >> spacecraftClassFullResponse
		0 * _
	...
	void "gets single entity (V2)"() {
		...
		then:
		1 * spacecraftClassApiMock.v2GetSpacecraftClass(UID) >> spacecraftClassV2FullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * spacecraftClassApiMock.v1SearchSpacecraftClasses(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, WARP_CAPABLE,
	...
	void "searches entities (V2)"() {
		...
		then:
		1 * spacecraftClassApiMock.v2SearchSpacecraftClasses(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, WARP_CAPABLE, MIRROR,
