...
class TechnologyTest extends AbstractTechnologyTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * technologyApiMock.v1Get(UID) >> technologyFullResponse
		0 * _
	...
	void "gets single entity (V2)"() {
		...
		then:
		1 * technologyApiMock.v2Get(UID) >> technologyV2FullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * technologyApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, BORG_TECHNOLOGY, BORG_COMPONENT,
	...
	void "searches entities (V2)"() {
		...
		then:
		1 * technologyApiMock.v2Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, BORG_TECHNOLOGY, BORG_COMPONENT,
				COMMUNICATIONS_TECHNOLOGY, COMPUTER_TECHNOLOGY, COMPUTER_PROGRAMMING, SUBROUTINE, DATABASE, ENERGY_TECHNOLOGY, FICTIONAL_TECHNOLOGY,
