...
class StapiSoapClientTest extends AbstractStapiClientTest {
	...
	void "soap client can be instantiated"() {
		...
		((String) toBindingProvider(stapiSoapClient.seriesPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.performerPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.staffPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.characterPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.episodePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.moviePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.astronomicalObjectPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.companyPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.comicSeriesPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.comicsPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.comicStripPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.comicCollectionPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.speciesPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.organizationPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.foodPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.locationPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.bookSeriesPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.bookPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.bookCollectionPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.magazinePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.magazineSeriesPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.literaturePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.seasonPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.videoReleasePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.tradingCardSetPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.tradingCardDeckPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.tradingCardPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.videoGamePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.soundtrackPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.weaponPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.spacecraftClassPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.spacecraftPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.titlePortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.materialPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.conflictPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.animalPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.elementPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.medicalConditionPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.technologyPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
		((String) toBindingProvider(stapiSoapClient.occupationPortType).requestContext.get(URL_KEY)).contains(StapiClient.CANONICAL_API_HTTP_URL)
	...
	void "when null URL is passed, canonical URL is used"() {
		...
		then:
		stapiSoapClient.apiUrl == StapiClient.CANONICAL_API_HTTP_URL
	}
