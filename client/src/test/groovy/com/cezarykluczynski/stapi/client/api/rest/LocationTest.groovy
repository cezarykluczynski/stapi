...
class LocationTest extends AbstractLocationTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * locationApiMock.v1Get(UID) >> locationFullResponse
		0 * _
	...
	void "gets single entity (V2)"() {
		...
		then:
		1 * locationApiMock.v2Get(UID) >> locationV2FullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * locationApiMock.v1Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, EARTHLY_LOCATION, FICTIONAL_LOCATION,
	...
	void "searches entities (V2)"() {
		...
		then:
		1 * locationApiMock.v2Search(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, EARTHLY_LOCATION, QONOS_LOCATION,
