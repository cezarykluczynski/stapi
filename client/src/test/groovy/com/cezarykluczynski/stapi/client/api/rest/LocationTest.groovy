...
class LocationTest extends AbstractLocationTest {
	...
	void "gets single entity"() {
		...
		then:
		1 * locationApiMock.v1GetLocation(UID) >> locationFullResponse
		0 * _
	...
	void "searches entities"() {
		...
		then:
		1 * locationApiMock.v1SearchLocations(PAGE_NUMBER, PAGE_SIZE, SORT_SERIALIZED, NAME, EARTHLY_LOCATION, FICTIONAL_LOCATION,
