...
class StapiRestSortSerializerTest extends Specification {
	...
	private static final RestSortOrder SORT_ORDER_1 = RestSortOrder.ASC
	private static final String NAME_2 = 'NAME_2'
	private static final RestSortOrder SORT_ORDER_2 = RestSortOrder.DESC

	def "serializes to string"() {
		given:
		List<RestSortClause> restSortClauseList = Lists.newArrayList(
				new RestSortClause(name: NAME_1, sortOrder: SORT_ORDER_1),
				new RestSortClause(name: NAME_2, sortOrder: SORT_ORDER_2)
		)
