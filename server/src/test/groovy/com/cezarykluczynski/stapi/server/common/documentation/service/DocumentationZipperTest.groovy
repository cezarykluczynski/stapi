...
class DocumentationZipperTest extends Specification {
	...
	private static final String ROOT_DIRECTORY = '../contract/src/main/resources/swagger'
	private static final String CONTRACT_DIRECTORY = 'contract/src/main/resources/swagger'
