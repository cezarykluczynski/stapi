...
class TechnologyBaseSoapMapperTest extends AbstractTechnologyMapperTest {

	private TechnologyBaseSoapMapper technologyBaseSoapMapper

	void setup() {
		technologyBaseSoapMapper = Mappers.getMapper(TechnologyBaseSoapMapper)
	}

	void "maps SOAP TechnologyBaseRequest to TechnologyRequestDTO"() {
		given:
		TechnologyBaseRequest technologyBaseRequest = new TechnologyBaseRequest(
				name: NAME,
	...
	void "maps DB entity to base SOAP entity"() {
		...
		when:
		TechnologyBase technologyBase = technologyBaseSoapMapper.mapBase(Lists.newArrayList(technology))[0]
