...
@Service
public class ComicSeriesSoapReader implements BaseReader<ComicSeriesRequest, ComicSeriesResponse> {
	...
	@Override
	public ComicSeriesResponse readBase(ComicSeriesRequest input) {
