...
import com.cezarykluczynski.stapi.sources.mediawiki.api.enums.MediaWikiSource as SourceMediaWikiSource
...
class PageBindingServiceTest extends Specification {
	...
	private static final SourceMediaWikiSource SOURCES_MEDIA_WIKI_SOURCE = SourceMediaWikiSource.MEMORY_ALPHA_EN
	...
	def setup() {
		...
		pageBindingService = new PageBindingService(pageRepositoryMock)
	}
