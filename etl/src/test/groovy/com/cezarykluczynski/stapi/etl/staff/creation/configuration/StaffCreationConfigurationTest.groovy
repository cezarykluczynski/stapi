...
class StaffCreationConfigurationTest extends AbstractCreationConfigurationTest {
	...
	def "StaffReader is created with all pages when step is not completed"() {
		...
		then:
		1 * jobCompletenessDeciderMock.isStepComplete(StepName.CREATE_STAFF) >> false
		...
		1 * categoryApiMock.getPages(CategoryName.CAMERA_AND_ELECTRICAL_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_CAMERA_AND_ELECTRICAL_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.CINEMATOGRAPHERS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_CINEMATOGRAPHERS)
		1 * categoryApiMock.getPages(CategoryName.CASTING_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_CASTING_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.COSTUME_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_COSTUME_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.COSTUME_DESIGNERS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_COSTUME_DESIGNERS)
		1 * categoryApiMock.getPages(CategoryName.DIRECTORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_DIRECTORS)
		1 * categoryApiMock.getPages(CategoryName.ASSISTANT_AND_SECOND_UNIT_DIRECTORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_ASSISTANT_AND_SECOND_UNIT_DIRECTORS)
		1 * categoryApiMock.getPages(CategoryName.EXHIBIT_AND_ATTRACTION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_EXHIBIT_AND_ATTRACTION_STAFF)
		...
		1 * categoryApiMock.getPages(CategoryName.LOCATION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_LOCATION_STAFF)
		...
		1 * categoryApiMock.getPages(CategoryName.MUSIC_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_MUSIC_DEPARTMENT)
		...
		1 * categoryApiMock.getPages(CategoryName.PERSONAL_ASSISTANTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_PERSONAL_ASSISTANTS)
		...
		1 * categoryApiMock.getPages(CategoryName.PRODUCTION_ASSOCIATES, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_PRODUCTION_ASSOCIATES)
		1 * categoryApiMock.getPages(CategoryName.PRODUCTION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_PRODUCTION_STAFF)
		1 * categoryApiMock.getPages(CategoryName.PUBLICATION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_PUBLICATION_STAFF)
		1 * categoryApiMock.getPages(CategoryName.SCIENCE_CONSULTANTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_SCIENCE_CONSULTANTS)
		1 * categoryApiMock.getPages(CategoryName.SOUND_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_SOUND_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.SPECIAL_AND_VISUAL_EFFECTS_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_SPECIAL_AND_VISUAL_EFFECTS_STAFF)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_AUDIO_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_AUDIO_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_CALENDAR_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_CALENDAR_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_COLOR_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_COLOR_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_INTERIOR_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_INTERIOR_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_INK_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_INK_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_PENCIL_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_PENCIL_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_LETTER_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_LETTER_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_COMIC_STRIP_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_COMIC_STRIP_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_GAME_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_GAME_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_GAME_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_GAME_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_NOVEL_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_NOVEL_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_NOVEL_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_NOVEL_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_REFERENCE_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_REFERENCE_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_REFERENCE_AUTHORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_REFERENCE_AUTHORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_PUBLICATION_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_PUBLICATION_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_PUBLICATION_DESIGNERS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_PUBLICATION_DESIGNERS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_PUBLICATION_EDITORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_PUBLICATION_EDITORS)
		1 * categoryApiMock.getPages(CategoryName.STAR_TREK_PUBLICITY_ARTISTS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STAR_TREK_PUBLICITY_ARTISTS)
		1 * categoryApiMock.getPages(CategoryName.CBS_DIGITAL_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_CBS_DIGITAL_STAFF)
		1 * categoryApiMock.getPages(CategoryName.ILM_PRODUCTION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_ILM_PRODUCTION_STAFF)
		1 * categoryApiMock.getPages(CategoryName.SPECIAL_FEATURES_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_SPECIAL_FEATURES_STAFF)
		1 * categoryApiMock.getPages(CategoryName.STORY_EDITORS, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STORY_EDITORS)
		1 * categoryApiMock.getPages(CategoryName.STUDIO_EXECUTIVES, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STUDIO_EXECUTIVES)
		1 * categoryApiMock.getPages(CategoryName.STUNT_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_STUNT_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.TRANSPORTATION_DEPARTMENT, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_TRANSPORTATION_DEPARTMENT)
		1 * categoryApiMock.getPages(CategoryName.VIDEO_GAME_PRODUCTION_STAFF, MediaWikiSource.MEMORY_ALPHA_EN) >> createListWithPageHeaderTitle(TITLE_VIDEO_GAME_PRODUCTION_STAFF)
	...
	def "StaffReader is created with no pages when step is completed"() {
		...
		then:
		1 * jobCompletenessDeciderMock.isStepComplete(StepName.CREATE_STAFF) >> true
		0 * _
