...
class RawDatelinkExtractingProcessorTest extends Specification {
	...
	def "extracts valid dates"() {
		...
		rawDatelinkExtractingProcessor.process("{{datelink|3|January|1965}} {{d|6|December|2016}}") == Lists.newArrayList(LocalDate.of(1965, 1, 3), LocalDate.of(2016, 12, 6))
	}

	def "does not extract invalid dates"() {
		expect:
