...
class TradingCardSetItemsProcessorTest extends Specification {

	private TradingCardSetItemsProcessor tradingCardSetItemsProcessor

	void setup() {
		tradingCardSetItemsProcessor = new TradingCardSetItemsProcessor()
	}

	@Unroll('when #input is passed, #output is returned')
	void "when string candidate is passed, packs per box is returned"() {
		expect:
		tradingCardSetItemsProcessor.process(input) == output
