...
class VideoTemplateDigitalFormatsEnrichingProcessorTest extends AbstractTemplateProcessorTest {
	...
	void "sets flagName when page is passed"() {
		...
		new Template(parts: Lists.newArrayList())                                                     | 'xboxSmartGlassDigital'     | null  | 0
		...
		new Template(parts: Lists.newArrayList(createTemplatePart(VideoTemplateParameter.DFXB, NO)))  | 'xboxSmartGlassDigital'     | false | 0
		...
		new Template(parts: Lists.newArrayList(createTemplatePart(VideoTemplateParameter.DFXB, YES))) | 'xboxSmartGlassDigital'     | true  | 1
