...
public class PerformerWriter implements ItemWriter<Performer> {
	...
	private List<Performer> process(Chunk<? extends Performer> performerList) {
	...
	private List<Performer> fromExtendsListToPerformerList(Chunk<? extends Performer> performerList) {
