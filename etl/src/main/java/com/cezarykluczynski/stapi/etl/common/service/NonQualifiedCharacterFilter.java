...
public class NonQualifiedCharacterFilter implements PageFilter<String> {
	...
	private static final List<String> REDIRECTS_TO_LISTS_PARTS = Lists.newArrayList(
			"Unnamed", "List of", "Mirror universe",
			"USS Voyager", "USS Enterprise", "EnterpriseNX", "Enterprise NX-01", "USS Excelsior",
			"computer voice", "deleted scene",
			...
			"Jem'Hadar ", "Gaia Klingon ", " Gaia Human",
			" 24th ", " 22nd ", "", " 23rd ", " 19th ", "Iotian ", " 20th ", "Starfleet Academy",
			"hologram", "Illusion ", "Quarren ", "Dabo girls", "DS9 ", "Sigma Draconis", "villager",
			...
			"Deep Space 9", "Changeling", "Humanoid Figure", "Hotel Royale", " settler", " official",
			...
			"school children", " cowboy", " attendee", " assassin", "boarding party", "Ekosian-Zeon", " associate", " commando",
			"starbase operations", " observer", " sentinel", "Wadi man", " assistant", " member", " dignitary", " resident", "Illusory people",
			" tactician", " old man", " citizen", " passerby", " civilian"
	);

	private static final List<String> REDIRECTS_TO_LISTS_EXACT = Lists.newArrayList(
			"Gul", "Sub-Commander", "Corporal", "Sergeant", "Colonel", "Major", "Constable", "Private", "android", "computer", "Legate",
