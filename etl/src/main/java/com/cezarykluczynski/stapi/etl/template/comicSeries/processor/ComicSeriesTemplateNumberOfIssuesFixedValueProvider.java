...
public class ComicSeriesTemplateNumberOfIssuesFixedValueProvider implements FixedValueProvider<String, Integer> {
	...
	static {
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek: Deep Space Nine (IDW)", 1);
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek Classics", 5);
		...
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek Annual (DC)", 8);
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek Annual (Western)", 12);
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek: The Next Generation (IDW)", 37);
		...
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek Comic", 5);
		...
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek: New Visions", 12);
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek Fotonovels", 12);
		TITLES_TO_NUMBER_OF_ISSUES.put("Star Trek: Boldly Go", 5);
